...
export const metadata: Metadata = {
  title: "Vavity - Virtual Autonomous Volatility Immunizing Tethering Yielder",
    description: "Vavity is an autonomous financial system that psychologically anchors asset prices before they fall.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Vavity - An autonomous financial system that psychologically anchors asset prices before they fall",
      },
    ],
    locale: "en_US",
    type: "website",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "@type": "Organization",
    "name": "Vavity",
    "description": "An autonomous financial system that psychologically anchors asset prices before they fall",
    "url": "https://vavity.info",
